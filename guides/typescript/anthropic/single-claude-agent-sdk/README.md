...
This example runs a coding agent with the capabilities of Claude Code inside a Nightona sandbox. You can interact with the agent via the CLI to run automations, build apps, and launch web apps or services using [Nightona preview links](https://www.daytona.io/docs/en/preview-and-authentication/#fetching-a-preview-link).
