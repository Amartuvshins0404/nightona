...
def main():
    ...
    sandbox2 = nightona.create(params=CreateSandboxFromSnapshotParams(network_block_all=True))
    ...
    sandbox3 = nightona.create(params=CreateSandboxFromSnapshotParams(network_allow_list="192.168.1.0/16,10.0.0.0/24"))
