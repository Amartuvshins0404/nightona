...
import io.nightona.sdk.DownloadStreamOptions;
import io.nightona.sdk.Sandbox;
import io.nightona.sdk.UploadStreamOptions;
    ...
    public static void main(String[] args) {
        try (Nightona nightona = new Nightona()) {
            ...
            try {
                ...
                sandbox.getFs().uploadFile("Hello, Nightona!".getBytes(StandardCharsets.UTF_8), "test-dir/hello.txt");
