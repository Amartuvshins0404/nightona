...
import { CompressedScreenshotResponse, RegionScreenshotResponse } from '@nightona-co/api-client'
import { ComputerUse, ScreenshotRegion } from '@nightona-co/sdk'
import { ScreenshotResponse } from '@nightona-co/toolbox-api-client'
