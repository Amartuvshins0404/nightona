...
import { TraceSpan, TraceSummary } from '@nightona-co/api-client'
      ...
      <EmptyHeader>
        ...
        {hasFilters ? (
          ...
          <EmptyDescription>
            ...
            <a href={`${NIGHTONA_DOCS_URL}/en/observability/otel-collection`} target="_blank" rel="noopener noreferrer">
