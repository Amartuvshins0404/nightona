---
title: 監査ログ
description: Nightona の組織全体にわたるすべてのユーザー操作を表示および監視します。
---

Nightona の監査ログは、組織全体のユーザーおよびシステムのアクティビティを詳細に記録します。サンドボックスのライフサイクルイベント、ユーザーアクセス、システム変更などの追跡にご利用ください。
...
以下は、Nightona によって記録されるアクションの全一覧です：
