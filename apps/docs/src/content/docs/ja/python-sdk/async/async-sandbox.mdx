...
- `snapshot` _str_ - サンドボックスの作成に使用された Nightona のスナップショット。
...
- `NightonaError` - タイムアウトが負の場合。サンドボックスの起動に失敗した場合、またはタイムアウトした場合。
...
- `NightonaError` - タイムアウトが負の場合、またはサンドボックスの停止に失敗した場合／タイムアウトした場合。
...
- `NightonaError` - タイムアウトが負の場合。サンドボックスの停止に失敗した場合、またはタイムアウトした場合。
