...
Nightona provides a browser-based web terminal for interacting with your sandboxes. The web terminal allows you to run commands, view files, and debug directly from your browser without installing any local tools.
...
Access the web terminal directly from the [Nightona Dashboard ↗](https://app.daytona.io/dashboard/sandboxes).
...
When you create a sandbox using the Nightona CLI, the web terminal URL is displayed automatically in the output.
...
```bash
nightona preview-url <sandbox-name> --port 22222
```
