...
- `toolbox_api` _NightonaApiClient:ToolboxApi_ - API client for sandbox operations
...
- `NightonaApiClient:ToolboxApi` - API client for sandbox operations
...
- `NightonaApiClient:ComputerUseStartResponse` - Computer use start response

**Raises**:

- `Nightona:Sdk:Error` - If the operation fails
...
- `NightonaApiClient:ComputerUseStopResponse` - Computer use stop response
...
- `NightonaApiClient:ComputerUseStatusResponse` - Status information about all VNC desktop processes
...
- `NightonaApiClient:ProcessStatusResponse` - Status information about the specific process
...
- `NightonaApiClient:ProcessRestartResponse` - Process restart response
...
- `NightonaApiClient:ProcessLogsResponse` - Process logs
...
- `NightonaApiClient:ProcessErrorsResponse` - Process error logs
...
- `sandbox_id` _String_ - The ID of the sandbox
- `toolbox_api` _NightonaToolboxApiClient:ComputerUseApi_ - API client for sandbox operations
- `otel_state` _Nightona:OtelState, nil_ -
...
- `NightonaToolboxApiClient:ComputerUseApi` - API client for sandbox operations
...
- `NightonaToolboxApiClient:AccessibilityTreeResponse` - Accessibility tree response
...
- `NightonaToolboxApiClient:AccessibilityNodesResponse` - Matching accessibility nodes
