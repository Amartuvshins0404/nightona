...
- `toolbox_api` _NightonaToolboxApiClient:GitApi_ - API client for Sandbox operations.
...
- `NightonaToolboxApiClient:GitApi` - API client for Sandbox operations
...
- `Nightona:Sdk:Error` - if adding files fails
...
- `NightonaApiClient:ListBranchResponse` - List of branches in the repository.

**Raises**:

- `Nightona:Sdk:Error` - if listing branches fails
...
- `Nightona:Sdk:Error` - if cloning repository fails
...
- `Nightona:Sdk:Error` - if committing changes fails
...
- `Nightona:Sdk:Error` - if pushing changes fails
...
- `Nightona:Sdk:Error` - if pulling changes fails
...
- `NightonaToolboxApiClient:GitStatus` - Repository status information including:

**Raises**:

- `Nightona:Sdk:Error` - if getting status fails
...
- `Nightona:Sdk:Error` - if checking out branch fails
...
- `Nightona:Sdk:Error` - if creating branch fails
...
- `Nightona:Sdk:Error` - if deleting branch fails
