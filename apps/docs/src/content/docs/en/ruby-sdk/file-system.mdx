...
- `toolbox_api` _NightonaToolboxApiClient:FileSystemApi_ - API client for Sandbox operations
...
- `NightonaToolboxApiClient:FileSystemApi` - API client for Sandbox operations
...
- `NightonaApiClient:FileInfo` - Detailed file information
...
- `Array\<NightonaApiClient:FileInfo\>` - List of file and directory information
...
- `on_progress` _Proc, nil_ - Optional callback invoked with a Nightona::DownloadProgress
...
- `Nightona:Sdk:Error` - If the file does not exist, the operation fails, or
...
- `Nightona:Sdk:Error` - If the operation fails or +cancel_event+ is set.
...
- `Array\<NightonaApiClient:Match\>` - List of matches found in files
...
- `NightonaApiClient:SearchFilesResponse`
...
- `Array\<NightonaApiClient:ReplaceResult\>` - List of results indicating replacements made in each file
