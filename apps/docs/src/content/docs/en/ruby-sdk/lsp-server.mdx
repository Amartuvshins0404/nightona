...
LspServer class for Nightona SDK.
...
- `toolbox_api` _NightonaToolboxApiClient:LspApi_ -
- `sandbox_id` _String_ -
...
- `NightonaToolboxApiClient:LspApi`
...
- `path` _String_ -
- `position` _Nightona:LspServer:Position_ -

**Returns**:

- `NightonaApiClient:CompletionList`
...
- `Array\<NightonaToolboxApiClient:LspSymbol]`
