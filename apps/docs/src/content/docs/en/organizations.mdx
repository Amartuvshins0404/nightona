...
Nightona provides organizations as a way to group resources and enable collaboration. Users can work individually in their personal organization or together in a collaborative organization.

Navigate to [Nightona Dashboard ↗](https://app.daytona.io/dashboard) to manage your organizations, or use the [API](/docs/en/tools/api/#nightona/tag/organizations) to manage them programmatically.

## Personal vs Collaborative

Every Nightona user starts with a personal organization, ideal for solo use and experimentation. Collaborative organizations are created manually and designed for company-wide collaboration with shared access and controls.
...
Users can switch between their personal and collaborative organizations by using the dropdown in the [Nightona Dashboard ↗](https://app.daytona.io/dashboard) sidebar. Each organization has its own sandboxes, API keys, and resource quotas.

## Create organization

Nightona provides options to create organizations in [Nightona Dashboard ↗](https://app.daytona.io/dashboard/) or programmatically using the [API](/docs/en/tools/api/#nightona/tag/organizations).

1. Navigate to [Nightona Dashboard ↗](https://app.daytona.io/dashboard/)
...
Nightona provides methods to list all organizations the authenticated user belongs to.
...
Nightona provides a method to get an organization by ID.
...
Nightona provides options to leave an organization in [Nightona Dashboard ↗](https://app.daytona.io/dashboard/) or programmatically using the [API](/docs/en/tools/api/#nightona/tag/organizations).
...
Nightona provides options to delete an organization in [Nightona Dashboard ↗](https://app.daytona.io/dashboard/) or programmatically using the [API](/docs/en/tools/api/#nightona/tag/organizations).
...
Nightona provides a method to create a new role in an organization.
...
Nightona provides a method to list all roles in an organization.
...
Nightona provides a method to update a role in an organization.
...
Nightona provides a method to delete a role in an organization.
...
Nightona provides methods to manage members in an organization.

### List members

Nightona provides a method to list all members in an organization.
...
Nightona provides a method to invite a new user to an organization.

1. Navigate to [Nightona Dashboard ↗](https://app.daytona.io/dashboard/members)
...
Nightona provides a method to remove a user from an organization.
...
Nightona provides options to update the access of a member in an organization in [Nightona Dashboard ↗](https://app.daytona.io/dashboard/members) or programmatically using the [API](/docs/en/tools/api/#nightona/tag/organizations).
...
Nightona provides methods to manage invitations in an organization.

1. Navigate to [Nightona Dashboard ↗](https://app.daytona.io/dashboard/user/invitations)
...
Nightona provides a method to get the number of invitations in an organization.
...
Nightona provides options to accept a pending organization invitation in [Nightona Dashboard ↗](https://app.daytona.io/dashboard/user/invitations) or programmatically using the [API](/docs/en/tools/api/#nightona/tag/organizations).
...
Nightona provides options to decline a pending organization invitation in [Nightona Dashboard ↗](https://app.daytona.io/dashboard/user/invitations) or programmatically using the [API](/docs/en/tools/api/#nightona/tag/organizations).
...
Nightona provides a method to list pending invitations for an organization.
...
Nightona provides options to update an invitation for an organization in [Nightona Dashboard ↗](https://app.daytona.io/dashboard/members) or programmatically using the [API](/docs/en/tools/api/#nightona/tag/organizations).
...
Nightona provides options to cancel an invitation for an organization in [Nightona Dashboard ↗](https://app.daytona.io/dashboard/members) or programmatically using the [API](/docs/en/tools/api/#nightona/tag/organizations).
...
Nightona provides options to set the default region programmatically using the [API](/docs/en/tools/api/#nightona/tag/organizations).
...
The settings page in the [Nightona Dashboard ↗](https://app.daytona.io/dashboard/settings) allows you to view the organization ID and name, and optionally delete the organization if you don't need it anymore. This action is irreversible, so please proceed with caution. Personal organizations are there by default and cannot be deleted.

## Advanced operations

Nightona provides methods to perform advanced operations on an organization.

### Usage overview

Nightona provides a method to get the usage overview for an organization.
...
Nightona provides a method to update the sandbox default limited network egress for an organization.
...
Nightona provides a method to update the experimental configuration for an organization.
