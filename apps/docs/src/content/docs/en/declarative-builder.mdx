...
```ruby
# Add a local file
image = Nightona::Image.debian_slim('3.12').add_local_file('package.json', '/home/daytona/package.json')

# Add a local directory
image = Nightona::Image.debian_slim('3.12').add_local_dir('src', '/home/daytona/src')
```
...
// Add a local file
version := "3.12"
image := nightona.DebianSlim(&version).AddLocalFile("package.json", "/home/daytona/package.json")

// Add a local directory
image := nightona.DebianSlim(&version).AddLocalDir("src", "/home/daytona/src")
```
...
```ruby
# Set environment variables
image = Nightona::Image.debian_slim('3.12').env({ 'PROJECT_ROOT' => '/home/daytona' })

# Set working directory
image = Nightona::Image.debian_slim('3.12').workdir('/home/daytona')
```
...
// Set environment variables
version := "3.12"
image := nightona.DebianSlim(&version).Env("PROJECT_ROOT", "/home/daytona")

// Set working directory
image := nightona.DebianSlim(&version).Workdir("/home/daytona")
```
...
image = (
  ...
  .run_commands(
    "groupadd -r nightona && useradd -r -g nightona -m -d /home/daytona nightona",
    "chown -R nightona:nightona /home/daytona",
  )
  .workdir("/home/daytona")
...
image := nightona.DebianSlim(&version).
  ...
  Run("groupadd -r nightona && useradd -r -g nightona -m -d /home/daytona nightona").
  Run("chown -R nightona:nightona /home/daytona").
  Workdir("/home/daytona").
  User("nightona")
```
