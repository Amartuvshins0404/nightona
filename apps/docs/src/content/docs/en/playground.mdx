---
title: Playground
description: Create sandboxes, run SDK operations, and explore Nightona features directly from your browser.
---

Nightona provides an interactive environment ("Playground") for creating sandboxes, running SDK operations, and exploring Nightona features directly from your browser.
...
Navigate to [Nightona Dashboard ↗](https://app.daytona.io/dashboard/playground) to access the playground.
