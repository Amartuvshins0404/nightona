...
print(f"NumPy version: {np.__version__}")
            ...
            await sandbox.fs.upload_file("local.txt", "/home/nightona/remote.txt")
...
print(f"NumPy version: {np.__version__}")
      ...
      // Upload a file - this operation will be traced
      await sandbox.fs.uploadFile('local.txt', '/home/nightona/remote.txt')
...
print(f"NumPy version: {np.__version__}")
        ...
        // Upload a file - this operation will be traced
        err = sandbox.Fs.UploadFile(ctx, "local.txt", "/home/nightona/remote.txt")
        if err != nil {
          log.Fatal(err)
        }
...
print(f'NumPy version: {np.__version__}')
      ...
      # Upload a file - this operation will be traced
      sandbox.fs.upload_file("local.txt", "/home/nightona/remote.txt")
...
- [New Relic](https://github.com/Amartuvshins0404/nightona/tree/main/examples/otel-dashboards/new-relic)
- [Grafana](https://github.com/Amartuvshins0404/nightona/tree/main/examples/otel-dashboards/grafana)
- [Datadog](https://github.com/Amartuvshins0404/nightona/tree/main/examples/otel-dashboards/datadog)
