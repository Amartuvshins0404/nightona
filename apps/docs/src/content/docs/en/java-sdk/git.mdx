...
Provides repository clone, branch, commit, status, and sync operations mapped to Nightona
...
- `io.nightona.sdk.exception.NightonaException` - if cloning fails
...
- `io.nightona.sdk.exception.NightonaException` - if the operation fails
...
- `io.nightona.sdk.exception.NightonaException` - if staging fails
...
- `io.nightona.sdk.exception.NightonaException` - if commit fails
...
- `io.nightona.sdk.exception.NightonaException` - if push fails
...
- `io.nightona.sdk.exception.NightonaException` - if pull fails
