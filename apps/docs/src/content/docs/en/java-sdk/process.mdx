...
- `NightonaException` - if execution fails
...
- `NightonaException` - if session creation fails
...
- `NightonaException` - if retrieval fails
...
- `NightonaException` - if streaming fails
...
- `NightonaException` - if sending input fails
...
- `NightonaException` - if listing fails
...
- `NightonaException` - if PTY session creation fails
...
- `NightonaException` - if websocket connection setup fails
...
- `NightonaException` - if resize fails
...
- `NightonaException` - if termination fails
