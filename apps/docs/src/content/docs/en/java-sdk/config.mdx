---
title: "NightonaConfig"
hideTitleOnPage: true
---

## NightonaConfig

Configuration used to initialize a `Nightona` client.
...
## NightonaConfig.Builder

Builder for creating immutable `NightonaConfig` instances.
...
- `apiKey` _String_ - Nightona API key
...
- `apiUrl` _String_ - API URL to use; defaults to `http://localhost:3000/api` when omitted
...
Builds a new immutable `NightonaConfig`.

**Returns**:

- `NightonaConfig` - configured `NightonaConfig` instance
