...
- `NightonaException` - if the Sandbox fails to start
...
- `NightonaException` - if start fails or times out
...
- `NightonaException` - if the Sandbox fails to stop
...
- `NightonaException` - if stop fails or times out
...
- `NightonaException` - if timeout is invalid, state becomes error, or timeout expires
...
- `NightonaException` - if deletion fails
...
- `NightonaException` - if label update fails
...
- `NightonaException` - if the update fails
...
- `NightonaException` - if the request fails
...
- `NightonaException` - if timeout is invalid, state becomes failure, or timeout expires
...
— including those not returned by `Nightona#list` — are populated.

**Throws**:

- `NightonaException` - if refresh fails
...
- `NightonaException` - if the fork operation fails or times out
...
- `NightonaException` - if the snapshot operation fails
...
- `NightonaException` - if the pause operation fails
...
- `NightonaException` - if timeout is negative or the operation fails/times out
...
- `String` - Nightona snapshot used to create this Sandbox, or `null` if none.
...
Not returned by `Nightona#list`; call `#refreshData()` on each item to populate.
