...
- `io.nightona.sdk.exception.NightonaException` - if creation fails
...
- `io.nightona.sdk.exception.NightonaException` - if deletion fails
...
- `io.nightona.sdk.exception.NightonaException` - if download or local read fails
...
- `io.nightona.sdk.exception.NightonaException` - if the file does not exist or access is denied
...
- `io.nightona.sdk.exception.NightonaException` - if download fails
...
- `io.nightona.sdk.exception.NightonaException` - if upload fails
...
- `io.nightona.sdk.exception.NightonaException` - if listing fails
...
- `io.nightona.sdk.exception.NightonaException` - if lookup fails
...
- `io.nightona.sdk.exception.NightonaException` - if the search request fails
...
- `io.nightona.sdk.exception.NightonaException` - if replacement fails
...
- `io.nightona.sdk.exception.NightonaException` - if move fails
