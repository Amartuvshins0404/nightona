...
const mountPath = '/home/nightona/s3'
...
public class App {
    public static void main(String[] args) {
        try (Nightona nightona = new Nightona()) {
            ...
            String mountPath = "/home/nightona/s3";
...
const mountPath = '/home/nightona/r2'
...
public class App {
    public static void main(String[] args) {
        try (Nightona nightona = new Nightona()) {
            ...
            String mountPath = "/home/nightona/r2";
...
mount_path = "/home/nightona/tigris"
...
const mountPath = '/home/nightona/tigris'
...
mountPath := "/home/nightona/tigris"
...
public class App {
    public static void main(String[] args) {
        try (Nightona nightona = new Nightona()) {
            ...
            String mountPath = "/home/nightona/tigris";
...
mount_path = "/home/nightona/gcs"
key_path = "/home/nightona/.gcs-key.json"
...
const mountPath = '/home/nightona/gcs'
const keyPath = '/home/nightona/.gcs-key.json'
...
mountPath := "/home/nightona/gcs"
keyPath := "/home/nightona/.gcs-key.json"
...
public class App {
    public static void main(String[] args) {
        try (Nightona nightona = new Nightona()) {
            ...
            String mountPath = "/home/nightona/gcs";
            String keyPath = "/home/nightona/.gcs-key.json";
...
mount_path = "/home/nightona/azure"
config_path = "/home/nightona/.blobfuse2.yaml"
...
const mountPath = '/home/nightona/azure'
const configPath = '/home/nightona/.blobfuse2.yaml'
...
mountPath := "/home/nightona/azure"
configPath := "/home/nightona/.blobfuse2.yaml"
...
public class App {
    public static void main(String[] args) {
        try (Nightona nightona = new Nightona()) {
            ...
            String mountPath = "/home/nightona/azure";
            String configPath = "/home/nightona/.blobfuse2.yaml";
...
Pass `ARCHIL_MOUNT_TOKEN`, `ARCHIL_REGION`, and `ARCHIL_DISK` to the sandbox via `envVars`. Your code then mounts the disk at `/home/nightona/archil` and hands ownership to the `nightona` user so non-root processes can read and write through the mount.
...
mount_path = "/home/nightona/archil"
...
const mountPath = '/home/nightona/archil'
...
mountPath := "/home/nightona/archil"
...
public class App {
    public static void main(String[] args) {
        try (Nightona nightona = new Nightona()) {
            String mountPath = "/home/nightona/archil";
...
The Mesa setup follows the same pattern as the bucket providers but uses the Mesa CLI rather than a FUSE-specific tool: install the CLI in your sandbox, authenticate with your API key, and run `mesa mount --daemonize` to mount your repos at `/home/nightona/mesa/mnt/<org>/<repo>`.
...
Pass `MESA_API_KEY` and your Mesa organization slug to the sandbox via `envVars`. Your code then writes a TOML config into the sandbox, authenticates the Mesa CLI, and mounts your repos at `/home/nightona/mesa/mnt/<org>/<repo>`.
...
repo = "my-workspace"
mount_path = f"/home/nightona/mesa/mnt/{org}/{repo}"
config_path = "/home/nightona/.config/mesa/config.toml"
...
config = f'''mount-point = "/home/nightona/mesa/mnt"
...
const mountPath = `/home/nightona/mesa/mnt/${org}/${repo}`
const configPath = '/home/nightona/.config/mesa/config.toml'
...
const config = `mount-point = "/home/nightona/mesa/mnt"
...
repo = 'my-workspace'
mount_path = "/home/nightona/mesa/mnt/#{org}/#{repo}"
config_path = '/home/nightona/.config/mesa/config.toml'
...
config = <<~TOML
  mount-point = "/home/nightona/mesa/mnt"
...
repo := "my-workspace"
mountPath := fmt.Sprintf("/home/nightona/mesa/mnt/%s/%s", org, repo)
configPath := "/home/nightona/.config/mesa/config.toml"
...
config := fmt.Sprintf(`mount-point = "/home/nightona/mesa/mnt"
...
public class App {
    public static void main(String[] args) {
        try (Nightona nightona = new Nightona()) {
            ...
            String mountPath = "/home/nightona/mesa/mnt/" + org + "/" + repo;
            String configPath = "/home/nightona/.config/mesa/config.toml";
            ...
            String config = "mount-point = \"/home/nightona/mesa/mnt\"\n\n"
                + "[secrets]\n"
                + "backend = \"plaintext-file\"\n\n"
                + "[organizations." + org + "]\n";
