...
sandbox.git.clone("https://github.com/Amartuvshins0404/nightona.git", "/home/daytona/nightona")
...
await sandbox.git.clone('https://github.com/Amartuvshins0404/nightona.git', '/home/daytona/nightona');
...
func main() {
    ...
    sandbox.Git.Clone(context.Background(), "https://github.com/Amartuvshins0404/nightona.git", "/home/daytona/nightona")
...
sandbox.git.clone(url: "https://github.com/Amartuvshins0404/nightona.git", path: "/home/daytona/nightona")
status = sandbox.git.status("/home/daytona/nightona")
