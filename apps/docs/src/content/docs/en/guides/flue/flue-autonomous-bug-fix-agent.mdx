...
Clone the Nightona [repository](https://github.com/Amartuvshins0404/nightona.git) and navigate to the example directory:
...
[flue] tool:start  read  /home/nightona/project/package.json
[flue] tool:done   read  (1477 chars)
[flue] tool:start  glob  **/*.test.*
[flue] tool:done   glob
[flue] tool:start  read  /home/nightona/project/src/index.ts
[flue] tool:start  read  /home/nightona/project/src/parse.test.ts
...
[flue] tool:done   bash
[flue] tool:start  edit  /home/nightona/project/src/parse.test.ts
[flue] tool:done   edit
...
[flue] tool:start  edit  /home/nightona/project/src/index.ts
[flue] tool:done   edit
