...
Clone the Nightona [repository](https://github.com/Amartuvshins0404/nightona) and go to the example directory:
...
You can change behavior by editing the constants in [`src/index.ts`](https://github.com/Amartuvshins0404/nightona/blob/main/guides/typescript/openclaw/src/index.ts):
