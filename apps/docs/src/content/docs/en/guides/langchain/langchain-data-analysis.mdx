...
Clone the [repository](https://github.com/Amartuvshins0404/nightona) and navigate to the example directory:
...
# Load the dataset
df = pd.read_csv('/home/nightona/dataset.csv')
...
file_bytes = tool.download_file("/home/nightona/results.csv")
```
...
Uploads a file to the sandbox. The file is placed in `/home/nightona/`.
