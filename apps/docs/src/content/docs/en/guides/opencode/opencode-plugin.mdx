...
To confirm the plugin is working, type `pwd` in the chat and you should see a path like `/home/nightona/project`.
...
For more information on how the sync is implemented, see the [SessionGitManager](https://github.com/Amartuvshins0404/nightona/blob/main/libs/opencode-plugin/.opencode/plugin/nightona/git/session-git-manager.ts) class.
