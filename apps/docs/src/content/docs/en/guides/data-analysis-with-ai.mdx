...
description: Use Nightona to run AI-generated code for data analysis and visualization.
---
...
You can use Nightona Sandbox to run AI-generated code to analyze data. Here's how the AI data analysis workflow typically looks:
...
## Build an AI Data Analyst with Nightona

This example shows how to build an AI-powered data analyst that automatically generates insights and visualizations from CSV data using Nightona's secure sandbox environment.
...
Install the Nightona SDK and Anthropic SDK to your project:

<Tabs syncKey="language">
  <TabItem label="Python" icon="seti:python">
    `bash pip install nightona anthropic python-dotenv `
  </TabItem>

  <TabItem label="TypeScript" icon="seti:typescript">
    `bash npm install @nightona/sdk @anthropic-ai/sdk dotenv `
  </TabItem>

  <TabItem label="Ruby" icon="seti:ruby">
    `bash gem install nightona anthropic dotenv `
  </TabItem>
</Tabs>
...
Now create a [Nightona sandbox](/docs/en/sandboxes/#create-sandboxes) and upload your dataset:
...
<Tabs syncKey="language">
  <TabItem label="Python" icon="seti:python">
    ...
    nightona = Nightona() # The sandbox language is Python by default.
    sandbox = nightona.create()

    # Upload the dataset to the sandbox

    sandbox.fs.upload_file("dataset.csv", "/home/nightona/dataset.csv")
  ...
  <TabItem label="TypeScript" icon="seti:typescript">
    ...
    // Create sandbox
    const nightona = new Nightona(); // The sandbox language is Python by default.
    const sandbox = await nightona.create()

    // Upload the dataset to the sandbox
    await sandbox.fs.uploadFile('dataset.csv', '/home/nightona/dataset.csv')
    ```
  </TabItem>
  ...
  <TabItem label="Ruby" icon="seti:ruby">
    ...
    # Create sandbox
    nightona = Nightona::Nightona.new # The sandbox language is Python by default.
    sandbox = nightona.create

    # Upload the dataset to the sandbox
    sandbox.fs.upload_file(File.read('dataset.csv'), '/home/nightona/dataset.csv')
    ```
  </TabItem>
</Tabs>
...
Now we'll create the core functionality that connects Claude with Nightona to analyze data and generate visualizations.
...
<Tabs syncKey="language">
  <TabItem label="Python" icon="seti:python">
    ...
    prompt = f"""
    I have a CSV file with vehicle valuations saved in the sandbox at /home/nightona/dataset.csv.
...
- **Secure execution:** Code runs in isolated Nightona sandboxes
...
- **Language agnostic:** While we used Python here, Nightona supports multiple languages
