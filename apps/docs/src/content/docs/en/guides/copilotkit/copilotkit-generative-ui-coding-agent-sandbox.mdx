...
Clone the [Nightona repository](https://github.com/Amartuvshins0404/nightona) and navigate to the example directory:
...
Work under /home/nightona by default. Reuse the same sandboxId across every
...
✓  done
$ cd /home/nightona && npm create vite@latest snake-game -- --template react-ts --yes && cd snake-game && npm install
...
│
◇  Scaffolding project in /home/nightona/snake-game...
│
└  Done. Now run:
...
✓  wrote  /home/nightona/snake-game/src/App.tsx                             4492 B

✓  wrote  /home/nightona/snake-game/src/App.css                             1527 B

✓  wrote  /home/nightona/snake-game/src/index.css                            307 B

✓  wrote  /home/nightona/snake-game/vite.config.ts                           273 B

✓  done
$ cd /home/nightona/snake-game && npm run build
...
```text
✓  wrote  /home/nightona/snake-game/src/App.css                             1529 B
