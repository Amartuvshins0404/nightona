...
RSpec.describe Nightona::CodeInterpreter do
  ...
  let(:toolbox_api) { instance_double(NightonaToolboxApiClient::InterpreterApi, api_client: api_client) }
  ...
  describe '#run_code' do
    ...
    it 'raises TimeoutError when the websocket closes with the timeout code' do
      ...
      expect { interpreter.run_code('sleep(10)', timeout: 1) }
        .to raise_error(Nightona::Sdk::TimeoutError, /Execution timed out/)
    end
    ...
    it 'wraps websocket errors as SDK errors' do
      ...
      expect { interpreter.run_code('print(1)') }.to raise_error(Nightona::Sdk::Error, /WebSocket error: socket boom/)
    end
  end
  ...
  describe '#create_context' do
    ...
    it 'wraps errors' do
      ...
      end.to raise_error(Nightona::Sdk::Error, /Failed to create interpreter context: err/)
    end
  end
  ...
  describe '#list_contexts' do
    ...
    it 'wraps errors' do
      ...
      end.to raise_error(Nightona::Sdk::Error, /Failed to list interpreter contexts: err/)
    end
  end
  ...
  describe '#delete_context' do
    ...
    it 'wraps errors' do
      ...
      end.to raise_error(Nightona::Sdk::Error, /Failed to delete interpreter context: err/)
    end
  end

  describe 'private helpers' do
    let(:result) { Nightona::ExecutionResult.new }
