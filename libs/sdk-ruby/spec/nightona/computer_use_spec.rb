...
RSpec.describe Nightona::ComputerUse do
  ...
  describe '#start' do
    ...
    it 'wraps errors' do
      ...
      expect { computer_use.start }.to raise_error(Nightona::Sdk::Error, /Failed to start computer use: err/)
    end
  end
  ...
  describe '#stop' do
    ...
    it 'wraps errors' do
      ...
      expect { computer_use.stop }.to raise_error(Nightona::Sdk::Error, /Failed to stop computer use: err/)
    end
  end
  ...
  describe '#status' do
    ...
    it 'wraps errors' do
      ...
      expect { computer_use.status }.to raise_error(Nightona::Sdk::Error, /Failed to get computer use status: err/)
    end
  end
  ...
  describe '#get_process_status' do
    ...
    it 'wraps errors' do
      ...
      expect { computer_use.get_process_status(process_name: 'xvfb') }
        .to raise_error(Nightona::Sdk::Error, /Failed to get process status: err/)
    end
  end
  ...
  describe '#restart_process' do
    ...
    it 'wraps errors' do
      ...
      expect { computer_use.restart_process(process_name: 'xfce4') }
        .to raise_error(Nightona::Sdk::Error, /Failed to restart process: err/)
    end
  end
  ...
  describe '#get_process_logs' do
    ...
    it 'wraps errors' do
      ...
      expect { computer_use.get_process_logs(process_name: 'novnc') }
        .to raise_error(Nightona::Sdk::Error, /Failed to get process logs: err/)
    end
  end
  ...
  describe '#get_process_errors' do
    ...
    it 'wraps errors' do
      ...
      expect { computer_use.get_process_errors(process_name: 'x11vnc') }
        .to raise_error(Nightona::Sdk::Error, /Failed to get process errors: err/)
    end
  end

  describe Nightona::ComputerUse::Mouse do
    ...
    it 'wraps position errors' do
      ...
      expect { mouse.position }.to raise_error(Nightona::Sdk::Error, /Failed to get mouse position: err/)
    end
    ...
    it 'wraps move errors' do
      ...
      expect { mouse.move(x: 1, y: 2) }.to raise_error(Nightona::Sdk::Error, /Failed to move mouse: err/)
    end
    ...
    it 'wraps click errors' do
      ...
      expect { mouse.click(x: 1, y: 2) }.to raise_error(Nightona::Sdk::Error, /Failed to click mouse: err/)
    end
    ...
    it 'wraps drag errors' do
      ...
      expect { mouse.drag(start_x: 1, start_y: 2, end_x: 3, end_y: 4) }
        .to raise_error(Nightona::Sdk::Error, /Failed to drag mouse: err/)
    end
    ...
    it 'wraps scroll errors' do
      ...
      expect { mouse.scroll(x: 1, y: 2, direction: 'down') }
        .to raise_error(Nightona::Sdk::Error, /Failed to scroll mouse: err/)
    end
  end

  describe Nightona::ComputerUse::Keyboard do
    ...
    it 'wraps type errors' do
      ...
      expect { keyboard.type(text: 'Hello') }.to raise_error(Nightona::Sdk::Error, /Failed to type text: err/)
    end
    ...
    it 'wraps press errors' do
      ...
      expect { keyboard.press(key: 'c', modifiers: ['ctrl']) }
        .to raise_error(Nightona::Sdk::Error, /Failed to press key: err/)
    end
    ...
    it 'wraps hotkey errors' do
      ...
      expect { keyboard.hotkey(keys: 'ctrl+c') }.to raise_error(Nightona::Sdk::Error, /Failed to press hotkey: err/)
    end
  end

  describe Nightona::ComputerUse::Screenshot do
    let(:screenshot) { described_class.new(sandbox_id: 'sandbox-123', toolbox_api: toolbox_api) }
    let(:region) { Nightona::ComputerUse::ScreenshotRegion.new(x: 10, y: 20, width: 300, height: 200) }
    ...
    it 'wraps full screen screenshot errors' do
      ...
      expect { screenshot.take_full_screen }.to raise_error(Nightona::Sdk::Error, /Failed to take screenshot: err/)
    end
    ...
    it 'wraps region screenshot errors' do
      ...
      expect { screenshot.take_region(region: region) }
        .to raise_error(Nightona::Sdk::Error, /Failed to take region screenshot: err/)
    end
    ...
    it 'takes a compressed region screenshot with explicit options' do
      ...
      options = Nightona::ComputerUse::ScreenshotOptions.new(show_cursor: true, format: 'jpeg', quality: 90, scale: 0.5)
    ...
    it 'wraps compressed screenshot errors' do
      ...
      end.to raise_error(Nightona::Sdk::Error, /Failed to take compressed screenshot: err/)
    end
    ...
    it 'wraps compressed region screenshot errors' do
      ...
      expect { screenshot.take_compressed_region(region: region) }
        .to raise_error(Nightona::Sdk::Error, /Failed to take compressed region screenshot: err/)
    end
  end

  describe Nightona::ComputerUse::Display do
    ...
    it 'wraps info errors' do
      ...
      expect { display.info }.to raise_error(Nightona::Sdk::Error, /Failed to get display info: err/)
    end
    ...
    it 'wraps window errors' do
      ...
      expect { display.windows }.to raise_error(Nightona::Sdk::Error, /Failed to get windows: err/)
    end
  end

  describe Nightona::ComputerUse::Accessibility do
    ...
    it 'wraps accessibility errors' do
      ...
      expect { accessibility.get_tree }
        .to raise_error(Nightona::Sdk::Error, /Failed to get accessibility tree: err/)
    end
  end

  describe Nightona::ComputerUse::Recording do
    ...
    it 'wraps start errors' do
      ...
      expect { recording.start }.to raise_error(Nightona::Sdk::Error, /Failed to start recording: err/)
    end
    ...
    it 'wraps stop errors' do
      ...
      expect { recording.stop(id: 'rec-1') }.to raise_error(Nightona::Sdk::Error, /Failed to stop recording: err/)
    end
    ...
    it 'wraps list errors' do
      ...
      expect { recording.list }.to raise_error(Nightona::Sdk::Error, /Failed to list recordings: err/)
    end
    ...
    it 'wraps get errors' do
      ...
      expect { recording.get(id: 'rec-1') }.to raise_error(Nightona::Sdk::Error, /Failed to get recording: err/)
    end
    ...
    it 'wraps delete errors' do
      ...
      expect { recording.delete(id: 'rec-1') }.to raise_error(Nightona::Sdk::Error, /Failed to delete recording: err/)
    end
    ...
    it 'removes partial files when the download fails' do
      ...
      Dir.mktmpdir do |dir|
        ...
        expect { recording.download(id: 'rec-1', local_path: path) }
          .to raise_error(Nightona::Sdk::Error, /Failed to download recording: Failed to download recording: HTTP 500/)
        expect(File.exist?(path)).to be(false)
      end
    end
  end

  describe Nightona::ComputerUse::ScreenshotRegion do
  ...
  describe Nightona::ComputerUse::ScreenshotOptions do
