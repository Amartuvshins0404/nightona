...
RSpec.describe Nightona::FileSystem do
  # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
  def multipart_response(parts, boundary: 'NIGHTONA-FILE-BOUNDARY')
    body = String.new.b
  ...
  def stub_streaming_request(chunks:, headers: nil, success: true, code: 200, body: nil)
    headers ||= { 'Content-Type' => 'multipart/form-data; boundary=NIGHTONA-FILE-BOUNDARY' }
  ...
  let(:toolbox_api) { instance_double(NightonaToolboxApiClient::FileSystemApi) }
  ...
  describe '#create_folder' do
    ...
    it 'wraps errors in Sdk::Error' do
      ...
      expect { fs.create_folder('/x', '755') }.to raise_error(Nightona::Sdk::Error, /Failed to create folder: fail/)
    end
  end
  ...
  describe '#delete_file' do
    ...
    it 'wraps errors' do
      ...
      expect { fs.delete_file('/x') }.to raise_error(Nightona::Sdk::Error, /Failed to delete file: nope/)
    end
  end
  ...
  describe '#get_file_info' do
    ...
    it 'wraps errors' do
      ...
      expect { fs.get_file_info('/x') }.to raise_error(Nightona::Sdk::Error, /Failed to get file info: err/)
    end
  end
  ...
  describe '#list_files' do
    ...
    it 'wraps errors' do
      ...
      expect { fs.list_files('/x') }.to raise_error(Nightona::Sdk::Error, /Failed to list files: err/)
    end
  end
  ...
  describe '#download_file' do
    ...
    it 'wraps errors' do
      ...
      expect { fs.download_file('/x') }.to raise_error(Nightona::Sdk::Error, /Failed to download file: err/)
    end
  end
  ...
  describe '#download_file_stream' do
    ...
    it 'raises error when file not found' do
      ...
      expect { fs.download_file_stream('/missing.txt') { |_chunk| nil } }
        .to raise_error(Nightona::Sdk::Error, /Failed to download file: file not found/)
    end
    ...
    it 'aborts when cancel_event is set before the first chunk' do
      ...
      expect { fs.download_file_stream('/remote.txt', cancel_event: cancel) { |_chunk| nil } }
        .to raise_error(Nightona::Sdk::Error, /Failed to download file: Download cancelled/)
    end
  end
  ...
  describe '#upload_file' do
    ...
    it 'wraps errors' do
      ...
      expect { fs.upload_file('data', '/x') }.to raise_error(Nightona::Sdk::Error, /Failed to upload file: err/)
    end
  end
  ...
  describe '#upload_file_stream' do
    it 'aborts when cancel_event is set before the upload starts' do
      ...
      expect { fs.upload_file_stream(io, '/remote.bin', cancel_event: cancel) }
        .to raise_error(Nightona::Sdk::Error, /Failed to upload file: Upload cancelled/)
    end
  ...
  describe '#upload_files' do
    it 'uploads multiple files' do
      allow(toolbox_api).to receive(:upload_file)
      files = [
        Nightona::FileUpload.new('content1', '/dest1'),
        Nightona::FileUpload.new('content2', '/dest2')
      ]
    ...
    it 'wraps errors from individual uploads' do
      ...
      expect { fs.upload_files([Nightona::FileUpload.new('content', '/dest')]) }
        .to raise_error(Nightona::Sdk::Error, /Failed to upload files: boom/)
    end
  end
  ...
  describe '#find_files' do
    ...
    it 'wraps errors' do
      ...
      expect { fs.find_files('/x', 'pat') }.to raise_error(Nightona::Sdk::Error, /Failed to find files: err/)
    end
  end
  ...
  describe '#search_files' do
    ...
    it 'wraps errors' do
      ...
      end.to raise_error(Nightona::Sdk::Error, /Failed to search files: err/)
    end
  end
  ...
  describe '#move_files' do
    ...
    it 'wraps errors' do
      ...
      expect { fs.move_files('/a', '/b') }.to raise_error(Nightona::Sdk::Error, /Failed to move files: err/)
    end
  end
  ...
  describe '#replace_in_files' do
    ...
    it 'wraps errors' do
      ...
      expect { fs.replace_in_files(files: [], pattern: 'a', new_value: 'b') }
        .to raise_error(Nightona::Sdk::Error, /Failed to replace in files: err/)
    end
  end
  ...
  describe '#set_file_permissions' do
    ...
    it 'wraps errors' do
      ...
      end.to raise_error(Nightona::Sdk::Error, /Failed to set file permissions: err/)
    end
  end
end
