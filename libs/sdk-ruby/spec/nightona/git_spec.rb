...
RSpec.describe Nightona::Git do
  let(:toolbox_api) { instance_double(NightonaToolboxApiClient::GitApi) }
  ...
  describe '#add' do
    ...
    it 'wraps errors' do
      ...
      expect { git.add('/repo', ['f']) }.to raise_error(Nightona::Sdk::Error, /Failed to add files: err/)
    end
  end
  ...
  describe '#branches' do
    ...
    it 'wraps errors' do
      ...
      expect { git.branches('/repo') }.to raise_error(Nightona::Sdk::Error, /Failed to list branches: err/)
    end
  end
  ...
  describe '#clone' do
    ...
    it 'wraps errors' do
      ...
      expect { git.clone(url: 'x', path: 'y') }.to raise_error(Nightona::Sdk::Error, /Failed to clone repository: err/)
    end
  end

  describe '#commit' do
    it 'creates a commit and returns GitCommitResponse' do
      commit_response = NightonaToolboxApiClient::GitCommitResponse.new(_hash: 'abc123def')
      ...
      expect(result).to be_a(Nightona::GitCommitResponse)
    ...
    it 'wraps errors' do
      ...
      expect { git.commit(path: '/r', message: 'm', author: 'a', email: 'e') }
        .to raise_error(Nightona::Sdk::Error, /Failed to commit changes: err/)
    end
  end
  ...
  describe '#push' do
    ...
    it 'wraps errors' do
      ...
      expect { git.push(path: '/r') }.to raise_error(Nightona::Sdk::Error, /Failed to push changes: err/)
    end
  end
  ...
  describe '#pull' do
    ...
    it 'wraps errors' do
      ...
      expect { git.pull(path: '/r') }.to raise_error(Nightona::Sdk::Error, /Failed to pull changes: err/)
    end
  end
  ...
  describe '#status' do
    ...
    it 'wraps errors' do
      ...
      expect { git.status('/r') }.to raise_error(Nightona::Sdk::Error, /Failed to get status: err/)
    end
  end
  ...
  describe '#checkout_branch' do
    ...
    it 'wraps errors' do
      ...
      expect { git.checkout_branch('/r', 'b') }.to raise_error(Nightona::Sdk::Error, /Failed to checkout branch: err/)
    end
  end
  ...
  describe '#create_branch' do
    ...
    it 'wraps errors' do
      ...
      expect { git.create_branch('/r', 'b') }.to raise_error(Nightona::Sdk::Error, /Failed to create branch: err/)
    end
  end
  ...
  describe '#delete_branch' do
    ...
    it 'wraps errors from the API call' do
      ...
      expect { git.delete_branch('/r', 'b') }.to raise_error(Nightona::Sdk::Error, /Failed to delete branch: err/)
    end
  end
end
