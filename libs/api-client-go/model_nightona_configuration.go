...
// checks if the NightonaConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NightonaConfiguration{}

// NightonaConfiguration struct for NightonaConfiguration
type NightonaConfiguration struct {
	// Nightona version
...
type _NightonaConfiguration NightonaConfiguration

// NewNightonaConfiguration instantiates a new NightonaConfiguration object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewNightonaConfiguration(version string, oidc OidcConfig, linkedAccountsEnabled bool, announcements map[string]Announcement, proxyTemplateUrl string, proxyToolboxUrl string, defaultSnapshot string, dashboardUrl string, maxAutoArchiveInterval float32, maintananceMode bool, environment string) *NightonaConfiguration {
	this := NightonaConfiguration{}
...
// NewNightonaConfigurationWithDefaults instantiates a new NightonaConfiguration object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewNightonaConfigurationWithDefaults() *NightonaConfiguration {
	this := NightonaConfiguration{}
	return &this
}

// GetVersion returns the Version field value
func (o *NightonaConfiguration) GetVersion() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *NightonaConfiguration) GetVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NightonaConfiguration) SetVersion(v string) {
	o.Version = v
}

// GetPosthog returns the Posthog field value if set, zero value otherwise.
func (o *NightonaConfiguration) GetPosthog() PosthogConfig {
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetPosthogOk() (*PosthogConfig, bool) {
	if o == nil || IsNil(o.Posthog) {
		return nil, false
	}
...
func (o *NightonaConfiguration) HasPosthog() bool {
	if o != nil && !IsNil(o.Posthog) {
		return true
	}
...
func (o *NightonaConfiguration) SetPosthog(v PosthogConfig) {
	o.Posthog = &v
}

// GetOidc returns the Oidc field value
func (o *NightonaConfiguration) GetOidc() OidcConfig {
	if o == nil {
		var ret OidcConfig
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetOidcOk() (*OidcConfig, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Oidc, true
...
func (o *NightonaConfiguration) SetOidc(v OidcConfig) {
	o.Oidc = v
}

// GetLinkedAccountsEnabled returns the LinkedAccountsEnabled field value
func (o *NightonaConfiguration) GetLinkedAccountsEnabled() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetLinkedAccountsEnabledOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NightonaConfiguration) SetLinkedAccountsEnabled(v bool) {
	o.LinkedAccountsEnabled = v
}

// GetAnnouncements returns the Announcements field value
func (o *NightonaConfiguration) GetAnnouncements() map[string]Announcement {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetAnnouncementsOk() (*map[string]Announcement, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NightonaConfiguration) SetAnnouncements(v map[string]Announcement) {
	o.Announcements = v
}

// GetPylonAppId returns the PylonAppId field value if set, zero value otherwise.
func (o *NightonaConfiguration) GetPylonAppId() string {
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetPylonAppIdOk() (*string, bool) {
	if o == nil || IsNil(o.PylonAppId) {
		return nil, false
	}
...
func (o *NightonaConfiguration) HasPylonAppId() bool {
	if o != nil && !IsNil(o.PylonAppId) {
		return true
	}
...
func (o *NightonaConfiguration) SetPylonAppId(v string) {
	o.PylonAppId = &v
}

// GetProxyTemplateUrl returns the ProxyTemplateUrl field value
func (o *NightonaConfiguration) GetProxyTemplateUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetProxyTemplateUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NightonaConfiguration) SetProxyTemplateUrl(v string) {
	o.ProxyTemplateUrl = v
}

// GetProxyToolboxUrl returns the ProxyToolboxUrl field value
func (o *NightonaConfiguration) GetProxyToolboxUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetProxyToolboxUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NightonaConfiguration) SetProxyToolboxUrl(v string) {
	o.ProxyToolboxUrl = v
}

// GetDefaultSnapshot returns the DefaultSnapshot field value
func (o *NightonaConfiguration) GetDefaultSnapshot() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetDefaultSnapshotOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NightonaConfiguration) SetDefaultSnapshot(v string) {
	o.DefaultSnapshot = v
}

// GetDashboardUrl returns the DashboardUrl field value
func (o *NightonaConfiguration) GetDashboardUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetDashboardUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NightonaConfiguration) SetDashboardUrl(v string) {
	o.DashboardUrl = v
}

// GetMaxAutoArchiveInterval returns the MaxAutoArchiveInterval field value
func (o *NightonaConfiguration) GetMaxAutoArchiveInterval() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetMaxAutoArchiveIntervalOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NightonaConfiguration) SetMaxAutoArchiveInterval(v float32) {
	o.MaxAutoArchiveInterval = v
}

// GetMaintananceMode returns the MaintananceMode field value
func (o *NightonaConfiguration) GetMaintananceMode() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetMaintananceModeOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NightonaConfiguration) SetMaintananceMode(v bool) {
	o.MaintananceMode = v
}

// GetEnvironment returns the Environment field value
func (o *NightonaConfiguration) GetEnvironment() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetEnvironmentOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NightonaConfiguration) SetEnvironment(v string) {
	o.Environment = v
}

// GetBillingApiUrl returns the BillingApiUrl field value if set, zero value otherwise.
func (o *NightonaConfiguration) GetBillingApiUrl() string {
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetBillingApiUrlOk() (*string, bool) {
	if o == nil || IsNil(o.BillingApiUrl) {
		return nil, false
	}
...
func (o *NightonaConfiguration) HasBillingApiUrl() bool {
	if o != nil && !IsNil(o.BillingApiUrl) {
		return true
	}
...
func (o *NightonaConfiguration) SetBillingApiUrl(v string) {
	o.BillingApiUrl = &v
}

// GetAnalyticsApiUrl returns the AnalyticsApiUrl field value if set, zero value otherwise.
func (o *NightonaConfiguration) GetAnalyticsApiUrl() string {
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetAnalyticsApiUrlOk() (*string, bool) {
	if o == nil || IsNil(o.AnalyticsApiUrl) {
		return nil, false
	}
...
func (o *NightonaConfiguration) HasAnalyticsApiUrl() bool {
	if o != nil && !IsNil(o.AnalyticsApiUrl) {
		return true
	}
...
func (o *NightonaConfiguration) SetAnalyticsApiUrl(v string) {
	o.AnalyticsApiUrl = &v
}

// GetSshGatewayCommand returns the SshGatewayCommand field value if set, zero value otherwise.
func (o *NightonaConfiguration) GetSshGatewayCommand() string {
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetSshGatewayCommandOk() (*string, bool) {
	if o == nil || IsNil(o.SshGatewayCommand) {
		return nil, false
	}
...
func (o *NightonaConfiguration) HasSshGatewayCommand() bool {
	if o != nil && !IsNil(o.SshGatewayCommand) {
		return true
	}
...
func (o *NightonaConfiguration) SetSshGatewayCommand(v string) {
	o.SshGatewayCommand = &v
}

// GetSshGatewayPublicKey returns the SshGatewayPublicKey field value if set, zero value otherwise.
func (o *NightonaConfiguration) GetSshGatewayPublicKey() string {
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetSshGatewayPublicKeyOk() (*string, bool) {
	if o == nil || IsNil(o.SshGatewayPublicKey) {
		return nil, false
	}
...
func (o *NightonaConfiguration) HasSshGatewayPublicKey() bool {
	if o != nil && !IsNil(o.SshGatewayPublicKey) {
		return true
	}
...
func (o *NightonaConfiguration) SetSshGatewayPublicKey(v string) {
	o.SshGatewayPublicKey = &v
}

// GetRateLimit returns the RateLimit field value if set, zero value otherwise.
func (o *NightonaConfiguration) GetRateLimit() RateLimitConfig {
...
// and a boolean to check if the value has been set.
func (o *NightonaConfiguration) GetRateLimitOk() (*RateLimitConfig, bool) {
	if o == nil || IsNil(o.RateLimit) {
		return nil, false
	}
...
func (o *NightonaConfiguration) HasRateLimit() bool {
	if o != nil && !IsNil(o.RateLimit) {
		return true
	}
...
func (o *NightonaConfiguration) SetRateLimit(v RateLimitConfig) {
	o.RateLimit = &v
}

func (o NightonaConfiguration) MarshalJSON() ([]byte, error) {
...
func (o NightonaConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *NightonaConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	varNightonaConfiguration := _NightonaConfiguration{}

	err = json.Unmarshal(data, &varNightonaConfiguration)

	if err != nil {
		return err
	}

	*o = NightonaConfiguration(varNightonaConfiguration)
...
type NullableNightonaConfiguration struct {
	value *NightonaConfiguration
	isSet bool
}

func (v NullableNightonaConfiguration) Get() *NightonaConfiguration {
	return v.value
}

func (v *NullableNightonaConfiguration) Set(val *NightonaConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableNightonaConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableNightonaConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNightonaConfiguration(val *NightonaConfiguration) *NullableNightonaConfiguration {
	return &NullableNightonaConfiguration{value: val, isSet: true}
}

func (v NullableNightonaConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNightonaConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
