...
export const RunnersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createRunner: async (createRunner: CreateRunner, xNightonaOrganizationID?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        deleteRunner: async (id: string, xNightonaOrganizationID?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getRunnerById: async (id: string, xNightonaOrganizationID?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listRunners: async (regionId?: string, xNightonaOrganizationID?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/runners`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        updateRunnerDraining: async (id: string, xNightonaOrganizationID?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateRunnerScheduling: async (id: string, xNightonaOrganizationID?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const RunnersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createRunner(createRunner: CreateRunner, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateRunnerResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createRunner(createRunner, xNightonaOrganizationID, options);
         ...
         * @throws {RequiredError}
         */
        async deleteRunner(id: string, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteRunner(id, xNightonaOrganizationID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getRunnerById(id: string, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Runner>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getRunnerById(id, xNightonaOrganizationID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async listRunners(regionId?: string, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Runner>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listRunners(regionId, xNightonaOrganizationID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async updateRunnerDraining(id: string, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Runner>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateRunnerDraining(id, xNightonaOrganizationID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async updateRunnerScheduling(id: string, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Runner>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateRunnerScheduling(id, xNightonaOrganizationID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const RunnersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createRunner(createRunner: CreateRunner, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig): AxiosPromise<CreateRunnerResponse> {
            return localVarFp.createRunner(createRunner, xNightonaOrganizationID, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Delete runner
         ...
         * @throws {RequiredError}
         */
        deleteRunner(id: string, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteRunner(id, xNightonaOrganizationID, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get info for authenticated runner
         ...
         * @throws {RequiredError}
         */
        getRunnerById(id: string, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig): AxiosPromise<Runner> {
            return localVarFp.getRunnerById(id, xNightonaOrganizationID, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get runner by sandbox ID
         ...
         * @throws {RequiredError}
         */
        listRunners(regionId?: string, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<Runner>> {
            return localVarFp.listRunners(regionId, xNightonaOrganizationID, options).then((request) => request(axios, basePath));
        },
        /**
         * Endpoint for version 2 runners to send healthcheck and metrics. Updates lastChecked timestamp and runner metrics.
         * @summary Runner healthcheck
         ...
         * @throws {RequiredError}
         */
        updateRunnerDraining(id: string, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig): AxiosPromise<Runner> {
            return localVarFp.updateRunnerDraining(id, xNightonaOrganizationID, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Update runner scheduling status
         ...
         * @throws {RequiredError}
         */
        updateRunnerScheduling(id: string, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig): AxiosPromise<Runner> {
            return localVarFp.updateRunnerScheduling(id, xNightonaOrganizationID, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class RunnersApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public createRunner(createRunner: CreateRunner, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig) {
        return RunnersApiFp(this.configuration).createRunner(createRunner, xNightonaOrganizationID, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public deleteRunner(id: string, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig) {
        return RunnersApiFp(this.configuration).deleteRunner(id, xNightonaOrganizationID, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public getRunnerById(id: string, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig) {
        return RunnersApiFp(this.configuration).getRunnerById(id, xNightonaOrganizationID, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public listRunners(regionId?: string, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig) {
        return RunnersApiFp(this.configuration).listRunners(regionId, xNightonaOrganizationID, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public updateRunnerDraining(id: string, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig) {
        return RunnersApiFp(this.configuration).updateRunnerDraining(id, xNightonaOrganizationID, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public updateRunnerScheduling(id: string, xNightonaOrganizationID?: string, options?: RawAxiosRequestConfig) {
        return RunnersApiFp(this.configuration).updateRunnerScheduling(id, xNightonaOrganizationID, options).then((request) => request(this.axios, this.basePath));
    }
}
