...
/**
 * Field used to order results from {@link io.nightona.sdk.Nightona#list}.
 *
...
public enum SandboxListSortField {
    ...
    public io.nightona.api.client.model.SandboxListSortField toApiClient() {
        return io.nightona.api.client.model.SandboxListSortField.fromValue(value);
    }
}
