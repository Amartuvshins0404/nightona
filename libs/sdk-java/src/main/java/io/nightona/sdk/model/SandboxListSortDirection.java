...
/**
 * Sort direction for {@link io.nightona.sdk.Nightona#list}.
 *
...
public enum SandboxListSortDirection {
    ...
    public io.nightona.api.client.model.SandboxListSortDirection toApiClient() {
        return io.nightona.api.client.model.SandboxListSortDirection.fromValue(value);
    }
}
