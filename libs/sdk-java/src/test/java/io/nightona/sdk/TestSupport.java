...
final class TestSupport {
    ...
    static io.nightona.api.client.model.Sandbox mainSandbox(String id, SandboxState state) {
        io.nightona.api.client.model.Sandbox sandbox = new io.nightona.api.client.model.Sandbox();
        sandbox.setId(id);
        sandbox.setOrganizationId("org-1");
        sandbox.setName("sandbox-" + id);
        sandbox.setUser("nightona");
    ...
    static io.nightona.api.client.model.Sandbox sandboxWithToolboxUrl(String id, SandboxState state, String toolboxUrl) {
        io.nightona.api.client.model.Sandbox sandbox = mainSandbox(id, state);
        sandbox.setToolboxProxyUrl(toolboxUrl);
        return sandbox;
    }

    static io.nightona.api.client.model.SandboxListItem mainSandboxListItem(String id, SandboxState state) {
        io.nightona.api.client.model.SandboxListItem sandbox = new io.nightona.api.client.model.SandboxListItem();
        sandbox.setId(id);
        sandbox.setOrganizationId("org-1");
        sandbox.setName("sandbox-" + id);
        sandbox.setUser("nightona");
    ...
    static NightonaConfig config() {
        return new NightonaConfig.Builder()
                .apiKey("test-key")
