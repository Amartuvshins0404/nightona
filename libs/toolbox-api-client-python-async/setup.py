...
NAME = "nightona_toolbox_api_client_async"
VERSION = "0.0.0-dev"
PYTHON_REQUIRES = ">= 3.9"
REQUIRES = [
...
setup(
    name=NAME,
    version=VERSION,
    description="Nightona Toolbox API",
    author="OpenAPI Generator community",
    author_email="team@openapitools.org",
    url="",
    keywords=["OpenAPI", "OpenAPI-Generator", "Nightona Toolbox API"],
    ...
    Nightona Toolbox API. The base URL comes from the sandbox&#39;s &#x60;toolboxProxyUrl&#x60; field (returned in sandbox DTO by the main Nightona API) plus the sandbox ID: &#x60;{toolboxProxyUrl}/{sandboxId}/{endpoint}&#x60;. Default for Nightona Cloud: &#x60;https://proxy.app.daytona.io/toolbox/{sandboxId}&#x60;.
    """,  # noqa: E501
    package_data={"nightona_toolbox_api_client_async": ["py.typed"]},
)
