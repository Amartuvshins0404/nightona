...
from nightona_api_client_async import BuildInfo, CreateSandboxSnapshot, ForkSandbox, PortPreviewUrl, ResizeSandbox
from nightona_api_client_async import Sandbox as SandboxDto
...
from nightona_toolbox_api_client_async import (
    ApiClient,
    ComputerUseApi,
    FileSystemApi,
    GitApi,
...
class AsyncSandbox(SandboxDto):
    ...
    async def _experimental_fork(self, name: str | None = None, timeout: float | None = 60) -> "AsyncSandbox":
        ...
        Example:
            ```python
            sandbox = await nightona.get("my-sandbox")
