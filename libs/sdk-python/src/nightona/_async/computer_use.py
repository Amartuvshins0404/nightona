...
class AsyncKeyboard:
    ...
    async def type(self, text: str, delay: int | None = None) -> None:
        ...
        Raises:
            NightonaError: If the type operation fails.
    ...
    async def press(self, key: str, modifiers: list[str] | None = None) -> None:
        ...
        Raises:
            NightonaError: If the press operation fails.
    ...
    async def hotkey(self, keys: str) -> None:
        ...
        Raises:
            NightonaError: If the hotkey operation fails.
...
class AsyncAccessibility:
    ...
    async def focus_node(self, node_id: str) -> None:
        ...
        Raises:
            NightonaError: If the focus operation fails. API failures may use a more specific subclass.
    ...
    async def invoke_node(self, node_id: str, action: str | None = None) -> None:
        ...
        Raises:
            NightonaError: If the invoke operation fails. API failures may use a more specific subclass.
    ...
    async def set_node_value(self, node_id: str, value: str) -> None:
        ...
        Raises:
            NightonaError: If the value update fails. API failures may use a more specific subclass.
