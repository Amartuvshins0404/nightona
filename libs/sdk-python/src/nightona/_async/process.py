...
class AsyncProcess:
    ...
    async def create_pty_session(
        ...
        Raises:
            NightonaError: If the PTY session creation fails or the session ID is already in use.
        """
    ...
    async def connect_pty_session(
        ...
        Raises:
            NightonaError: If the PTY session doesn't exist or connection fails.
        """
    ...
    async def get_pty_session_info(self, session_id: str) -> PtySessionInfo:
        ...
        Raises:
            NightonaError: If the PTY session doesn't exist.
    ...
    async def kill_pty_session(self, session_id: str) -> None:
        ...
        Raises:
            NightonaError: If the PTY session doesn't exist or cannot be killed.
    ...
    async def resize_pty_session(self, session_id: str, pty_size: PtySize) -> PtySessionInfo:
        ...
        Raises:
            NightonaError: If the PTY session doesn't exist or resize operation fails.
