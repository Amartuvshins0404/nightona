...
from nightona_toolbox_api_client_async import PtySessionInfo
...
class AsyncPtyHandle:
    ...
    async def _handle_websocket(self) -> None:
        ...
        # stops on CLOSE without exposing the close code/reason — but the nightona daemon
    ...
    async def _handle_message(self, message: str | bytes) -> None:
        ...
        try:
            ...
            raise NightonaError(f"Error handling PTY message: {e}") from e
