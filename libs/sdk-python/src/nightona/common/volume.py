...
from nightona_api_client import SandboxVolume as ApiVolumeMount
from nightona_api_client import VolumeDto
from nightona_api_client_async import SandboxVolume as AsyncApiVolumeMount
from nightona_api_client_async import VolumeDto as AsyncVolumeDto
...
class Volume(VolumeDto):
    """Represents a Nightona Volume which is a shared storage volume for Sandboxes.
