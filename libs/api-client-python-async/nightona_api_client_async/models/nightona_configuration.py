...
class NightonaConfiguration(BaseModel):
    """
    NightonaConfiguration
    """ # noqa: E501
    version: StrictStr = Field(description="Nightona version")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NightonaConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NightonaConfiguration from a dict"""
        if obj is None:
            return None
