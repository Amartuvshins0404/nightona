...
from nightona_api_client_async.api_client import ApiClient, RequestSerialized
from nightona_api_client_async.api_response import ApiResponse
from nightona_api_client_async.rest import RESTResponseType
...
class ToolboxApi:
    ...
    async def click_mouse_deprecated(
        ...
        x_nightona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        ...
        :param x_nightona_organization_id: Use with JWT to specify the organization ID
        :type x_nightona_organization_id: str
        ...
        _param = self._click_mouse_deprecated_serialize(
            ...
            x_nightona_organization_id=x_nightona_organization_id,
    ...
    def _click_mouse_deprecated_serialize(
        ...
        if x_nightona_organization_id is not None:
            _header_params['X-Nightona-Organization-ID'] = x_nightona_organization_id
