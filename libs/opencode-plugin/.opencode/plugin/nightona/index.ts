...
/**
 * OpenCode Plugin: Nightona Sandbox Integration
 *
 ...
 *
 * This plugin integrates Nightona sandboxes with OpenCode, providing isolated development
...
import { NightonaSessionManager } from './core/session-manager'
...
const LOG_FILE = join(xdgData, 'opencode', 'log', 'nightona.log')
const STORAGE_DIR = join(xdgData, 'opencode', 'storage', 'nightona')
const REPO_PATH = '/home/nightona/project'

setLogFilePath(LOG_FILE)
const sessionManager = new NightonaSessionManager(process.env.NIGHTONA_API_KEY || '', STORAGE_DIR, REPO_PATH)

async function nightonaPlugin(ctx: PluginInput) {
