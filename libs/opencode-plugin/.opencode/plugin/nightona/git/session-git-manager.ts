...
/**
 * SessionGitManager: Combines NightonaSandboxGitManager and HostGitManager for session lifecycle git operations.
 */
export class SessionGitManager {
  private readonly sandboxGit: NightonaSandboxGitManager
  ...
  constructor(sandbox: Sandbox, repoPath: string, worktree: string, branchNumber: number) {
    ...
    this.sandboxGit = new NightonaSandboxGitManager(sandbox, repoPath)
